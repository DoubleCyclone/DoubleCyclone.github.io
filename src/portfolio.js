...
const achievementSection = {
  ...
  subtitle: "Achievements that I am proud of",

  achievementsCards: [
    {
      title:
        "Innovations in Intelligent Systems and Applications Conference Participant",
      subtitle:
        "Participated in a conference with my capstone project and got it published on IEEE.",
      image: require("./assets/images/asyuLogo.png"),
      imageAlt: "Google Code-In Logo",
      footerLink: [
        {
          name: "Certification",
          url: "https://drive.google.com/file/d/1u2-L5t2nLahuaNFuB6GQMgOnqvnWyekT/view?usp=drive_link"
        },
        {
          name: "Link to the paper",
          url: "https://ieeexplore.ieee.org/document/10296706/"
        } /*,
        {
